...
class SettingController extends Controller
{
    ...
    public function index()
    {
        ...
        $settings = [
            ...
            'olt_log_limit' => $this->getSettingValue('olt_log_limit', '5000'),
            ...
            'microtik_main_prefix' => $this->getSettingValue('microtik_main_prefix', 'Main'),
            'microtik_local_prefix' => $this->getSettingValue('microtik_local_prefix', 'SuperClick'),
            'microtik_udp_port' => $this->getSettingValue('microtik_udp_port', '515'),
            'microtik_log_limit' => $this->getSettingValue('microtik_log_limit', '1000'),
    ...
    public function update(Request $request)
    {
        $request->validate([
            ...
            'olt_log_limit' => 'nullable|integer|min:1|max:100000',
            ...
            'microtik_main_prefix' => 'nullable|string|max:255',
            'microtik_local_prefix' => 'nullable|string|max:255',
            'microtik_udp_port' => 'nullable|integer|min:1|max:65535',
            'microtik_log_limit' => 'nullable|integer|min:1|max:100000',
    ...
    private function settingFieldDefinitions(): array
    {
        return [
            ...
            'microtik_main_prefix' => ['group' => 'microtik'],
            'microtik_local_prefix' => ['group' => 'microtik'],
            'microtik_udp_port' => ['group' => 'microtik'],
            'microtik_log_limit' => ['group' => 'microtik'],
